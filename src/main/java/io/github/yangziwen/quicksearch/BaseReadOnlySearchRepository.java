...
public class BaseReadOnlySearchRepository<E> implements BaseReadOnlyRepository<E>  {
    ...
    protected BaseReadOnlySearchRepository(RestHighLevelClient client) {
        this(client, RequestOptions.DEFAULT);
    }

    protected BaseReadOnlySearchRepository(RestHighLevelClient client, RequestOptions options) {
